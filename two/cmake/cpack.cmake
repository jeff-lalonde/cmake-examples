# Configure CPack.
#
# On Linux, the default package generator is DEB.
# On MacOS, the default package generator is PACKAGEMAKER.
# On Windows, the default package generator is NSIS.
...
if (WIN32)
    # Use NSIS (Nullsoft Scriptable Install System) for Windows.
    set(DEFAULT_CPACK_GENERATOR NSIS)
elseif (APPLE)
    # Use DragNDrop package for MacOS.
    set(DEFAULT_CPACK_GENERATOR DragNDrop)
elseif (UNIX)
    # Use debian package for Linux.
